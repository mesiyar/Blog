<template>
    <div id="layout-footer">
        ...
        <div class="copyright">Copyright © 2021 by <a target="_blank" class="out-link" href="https://www.learnkai.top">learnkai.top</a> . All rights reserved. | <a target="_blank" class="out-link" href="http://www.beian.miit.gov.cn">粤ICP备2021007967号-1</a></div>
    </div>
</template>
