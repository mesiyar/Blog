    ...
    <div id="layout-header" :class="{'fixed':fixed,'hidden':hidden}" @click.stop="mobileShow=false">
        <div class="site-logo">
            <router-link to="/">
                ...
                <p class="site-name">{{siteInfo.site_name}}</p>
            </router-link>
        </div>
        ...
        <div class="site-menus" :class="{'mobileShow':mobileShow}" @click.stop="mobileShow=!mobileShow">
            ...
            <div class="menu-item hasChild">
                <a href="#">文章</a>
                <div class="childMenu" v-if="category.lists">
                    <div class="sub-menu" v-for="item in category.lists" :key="item.id"><router-link :to="`/category/${item.name}`">{{item.name}}</router-link></div>
                </div>
            </div>
...
<script>
    ...
    import {fetchCategory,fetchSiteInfo} from '../../api'
    export default {
        name: "layout-header",
