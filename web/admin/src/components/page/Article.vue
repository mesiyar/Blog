<template>
            ...
            >
                ...
                <el-table-column label="状态" align="center">
                    <template slot-scope="scope">
                        <el-tag :type="scope.row.state == 1 ? 'success' : 'error'">{{ scope.row.state == 1 ? '正常' : '禁用' }}</el-tag>
                    </template>
                </el-table-column>
                <el-table-column label="置顶" align="center">
                    <template slot-scope="scope">
                        <el-tag :type="scope.row.is_top == 1 ? 'success' : 'error'">{{ scope.row.is_top == 1 ? '置顶' : '无' }}</el-tag>
                    </template>
                </el-table-column>
 ...
 <el-form-item label="置顶">
  ...
  inactive-text="否"> 
                ...
                <el-form-item label="内容">
                     <mavon-editor v-model="createForm.content" ref="md" @imgAdd="$imgAdd" @change="change" style="min-height: 600px"/>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
